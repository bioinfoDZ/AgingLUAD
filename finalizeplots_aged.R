...
#dir to write to
outdir <- "finalized_start-to-end-2021.02.20/A_aged_kras_correlation/update_final"
dir.create(outdir)
...
generes <- 'finalized_start-to-end-2021.02.20/A_aged_kras_correlation//jackknifesummary.csv'
